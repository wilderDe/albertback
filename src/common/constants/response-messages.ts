...
export enum Messages {
  ...
  //Categoria
  REPEATED_NAME_CATEGORIA = 'Nombre de la categoria repetido',
  NOT_FOUNT_CATEGORIA_ID = 'No se encontro la categoria con el id seleccionado',
  EXIST_NAME__CATEGORIA_REPEAT = 'Ya existe el nombre de la categoria',
}
