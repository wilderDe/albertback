  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const items = [
      //Seccion Eventos
      {
        ...
        label: 'Eventos',
        propiedades: {
          descripcion: 'Sección de gestión de Eventos',
          orden: 1,
        },
        subMenus: [
          {
            ...
            propiedades: {
              icono: 'category',
              descripcion: 'Gestión de categorias de eventos',
              orden: 1,
            },
          },
          {
            ...
            propiedades: {
              icono: 'folder',
              descripcion: 'Información de los Eventos',
              orden: 2,
            },
          },
          {
            nombre: 'items',
            url: '/admin/item',
            label: 'Sub Eventos items',
            propiedades: {
              icono: 'event',
              descripcion: 'Información de los sub eventos items',
              orden: 3,
            },
          },
        ],
